...
public class GlobalExceptionHandler {
	...
	@ResponseStatus(HttpStatus.BAD_REQUEST) // will add documentation for 404 error we get when exception is thrown
	public ResponseEntity<?> outOfStock(OutOfStockException ex, WebRequest request) {
